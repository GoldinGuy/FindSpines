...
class AnchorGeneratorBuilderTest(tf.test.TestCase):
    ...
    def test_build_grid_anchor_generator_with_defaults(self):
     ...
     """
        ...
        self.assertAllEqual(
            anchor_generator_object._base_anchor_size, [256, 256])
    ...
    def test_build_grid_anchor_generator_with_non_default_parameters(self):
     ...
     """
        ...
        self.assertAllEqual(
            anchor_generator_object._base_anchor_size, [128, 512])
    ...
    """
        ...
        for actual_aspect_ratio, expected_aspect_ratio in zip(
            ...
            self.assert_almost_list_equal(
                expected_aspect_ratio, actual_aspect_ratio)
        self.assertAllClose(
            anchor_generator_object._base_anchor_size, [1.0, 1.0])
