...
class PreprocessorBuilderTest(tf.test.TestCase):
    ...
    """
        ...
        self.assert_dictionary_close(
            args, {'min_delta': 0.7, 'max_delta': 1.1})
    ...
    """
        ...
        self.assert_dictionary_close(
            args, {'min_delta': 0.75, 'max_delta': 1.15})
    ...
    """
        ...
        function, args = preprocessor_builder.build(preprocessor_proto)
        self.assertEqual(
            function, preprocessor.scale_boxes_to_pixel_coordinates)
        self.assertEqual(args, {})
    ...
    """
        ...
        function, args = preprocessor_builder.build(preprocessor_proto)
        self.assertEqual(
            function, preprocessor.ssd_random_crop_fixed_aspect_ratio)
        self.assertEqual(args, {'min_object_covered': [0.0, 0.25],
                                'aspect_ratio': 0.875,
                                'area_range': [(0.5, 1.0), (0.5, 1.0)],
                                'overlap_thresh': [0.0, 0.25],
    ...
    """
        ...
        function, args = preprocessor_builder.build(preprocessor_proto)
        self.assertEqual(
            function, preprocessor.convert_class_logits_to_softmax)
