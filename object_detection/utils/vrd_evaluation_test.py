...
class VRDRelationDetectionEvaluatorTest(tf.test.TestCase):
    ...
    def test_vrdrelation_evaluator(self):
        ...
        self.assertAlmostEqual(
            metrics['VRDMetric_Relationships_AP@0.5IOU/4'], 0)
...
class VRDPhraseDetectionEvaluatorTest(tf.test.TestCase):
    ...
    def test_vrdphrase_evaluator(self):
        ...
        self.assertAlmostEqual(
            metrics['VRDMetric_Phrases_weightedAP@0.5IOU'], 0.25)
        ...
        self.assertAlmostEqual(
            metrics['VRDMetric_Phrases_Recall@50@0.5IOU'], 0.25)
        self.assertAlmostEqual(
            metrics['VRDMetric_Phrases_Recall@100@0.5IOU'], 0.25)
...
class VRDDetectionEvaluationTest(tf.test.TestCase):
    ...
    def setUp(self):
        ...
        self.assertAlmostEqual(expected_median_rank_100,
                               metrics.median_rank_100)
