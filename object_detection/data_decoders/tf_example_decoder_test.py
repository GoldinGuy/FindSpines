...
class TfExampleDecoderTest(tf.test.TestCase):
    ...
    def testDecodeJpegImage(self):
        ...
        self.assertAllEqual(
            decoded_jpeg, tensor_dict[fields.InputDataFields.image])
        self.assertAllEqual([4, 5], tensor_dict[fields.InputDataFields.
                                                original_image_spatial_shape])
        self.assertEqual(
            'image_id', tensor_dict[fields.InputDataFields.source_id])
    ...
    def testDecodeImageKeyAndFilename(self):
        ...
        self.assertEqual(
            'filename', tensor_dict[fields.InputDataFields.filename])
    ...
    def testDecodePngImage(self):
        ...
        self.assertAllEqual(
            decoded_png, tensor_dict[fields.InputDataFields.image])
        self.assertAllEqual([4, 5], tensor_dict[fields.InputDataFields.
                                                original_image_spatial_shape])
        self.assertEqual(
            'image_id', tensor_dict[fields.InputDataFields.source_id])
    ...
    def testDecodePngInstanceMasks(self):
        image_tensor = np.random.randint(
            256, size=(10, 10, 3)).astype(np.uint8)
        encoded_jpeg = self._EncodeImage(image_tensor)
